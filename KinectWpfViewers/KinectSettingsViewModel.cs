...
namespace Microsoft.Samples.Kinect.WpfViewers
{
    ...
    internal class KinectSettingsViewModel : DependencyObject
    {
        ...
        public KinectSettingsViewModel()
        {
            ...
            ColorModes = new ReadOnlyObservableCollection<ColorMode>(colorModes);
            ...
            DepthModes = new ReadOnlyObservableCollection<DepthMode>(depthModes);
            ...
            DepthRanges = new ReadOnlyObservableCollection<DepthRange>(depthRanges);
            ...
            PowerLineFrequencyStates = new ReadOnlyObservableCollection<PowerLineFrequency>(freqs);
            ...
            BacklightCompensationModeStates = new ReadOnlyObservableCollection<BacklightCompensationMode>(bcms);
            ...
            ToggleStates = new ReadOnlyObservableCollection<ToggleState>(toggleStates);
            ...
            DepthTreatments = new ReadOnlyObservableCollection<KinectDepthTreatment>(depthTreatments);
            ...
            SkeletonModes = new ReadOnlyObservableCollection<SkeletonMode>(skeletonModes);
            ...
            SkeletonChooserModes = new ReadOnlyObservableCollection<SkeletonChooserMode>(skeletonChooserModes);

            var currentColorFormatBinding = new Binding("KinectSensorManager.ColorFormat");
            currentColorFormatBinding.Source = this;
            BindingOperations.SetBinding(this, CurrentSensorColorFormatProperty, currentColorFormatBinding);

            var currentColorEnabledBinding = new Binding("KinectSensorManager.ColorStreamEnabled");
            currentColorEnabledBinding.Source = this;
            BindingOperations.SetBinding(this, CurrentSensorColorEnabledProperty, currentColorEnabledBinding);

            var currentDepthBinding = new Binding("KinectSensorManager.DepthFormat");
            currentDepthBinding.Source = this;
            BindingOperations.SetBinding(this, CurrentSensorDepthFormatProperty, currentDepthBinding);

            var currentDepthEnabledBinding = new Binding("KinectSensorManager.DepthStreamEnabled");
            currentDepthEnabledBinding.Source = this;
            BindingOperations.SetBinding(this, CurrentSensorDepthEnabledProperty, currentDepthEnabledBinding);
            ...
            BindingOperations.SetBinding(this, CurrentSensorSkeletonTrackingModeProperty, currentSkeletonTrackingBinding);
            ...
            BindingOperations.SetBinding(this, CurrentSensorSkeletonEnabledProperty, currentSkeletonEnabledBinding);
        }
        ...
        {
            get { return (ReadOnlyObservableCollection<ColorMode>)GetValue(ColorModesProperty); }
            private set { SetValue(ColorModesPropertyKey, value); }
        }
        ...
        {
            get { return (ReadOnlyObservableCollection<DepthMode>)GetValue(DepthModesProperty); }
            private set { SetValue(DepthModesPropertyKey, value); }
        }
        ...
        {
            get { return (ReadOnlyObservableCollection<DepthRange>)GetValue(DepthRangesProperty); }
            private set { SetValue(DepthRangesPropertyKey, value); }
        }

        public ReadOnlyObservableCollection<PowerLineFrequency> PowerLineFrequencyStates
        {
            get { return (ReadOnlyObservableCollection<PowerLineFrequency>)GetValue(PowerLineFrequencyStatesProperty); }
            private set { SetValue(PowerLineFrequencyStatesPropertyKey, value); }
        }

        public ReadOnlyObservableCollection<BacklightCompensationMode> BacklightCompensationModeStates
        {
            get { return (ReadOnlyObservableCollection<BacklightCompensationMode>)GetValue(BacklightCompensationModeStatesProperty); }
            private set { SetValue(BacklightCompensationModeStatesPropertyKey, value); }
        }

        public ReadOnlyObservableCollection<ToggleState> ToggleStates
        {
            get { return (ReadOnlyObservableCollection<ToggleState>)GetValue(ToggleStatesProperty); }
            private set { SetValue(ToggleStatesPropertyKey, value); }
        }

        public ReadOnlyObservableCollection<KinectDepthTreatment> DepthTreatments
        {
            get { return (ReadOnlyObservableCollection<KinectDepthTreatment>)GetValue(DepthTreatmentsProperty); }
            private set { SetValue(DepthTreatmentsPropertyKey, value); }
        }
        ...
        {
            get { return (ReadOnlyObservableCollection<SkeletonMode>)GetValue(SkeletonModesProperty); }
            private set { SetValue(SkeletonModesPropertyKey, value); }
        }
        ...
        {
            get { return (ReadOnlyObservableCollection<SkeletonChooserMode>)GetValue(SkeletonChooserModesProperty); }
            private set { SetValue(SkeletonChooserModesPropertyKey, value); }
        }
