...
namespace Microsoft.Samples.Kinect.WpfViewers
{
    ...
    public class KinectSensorManager : Freezable
    {
        ...
        {
            get { return (bool)GetValue(KinectSensorEnabledProperty); }
            set { SetValue(KinectSensorEnabledProperty, value); }
        }

        public bool KinectSensorAppConflict
        {
            get { return (bool)GetValue(KinectSensorAppConflictProperty); }
            private set { SetValue(KinectSensorAppConflictPropertyKey, value); }
        }

        public bool ColorStreamEnabled
        {
            get { return (bool)GetValue(ColorStreamEnabledProperty); }
            set { SetValue(ColorStreamEnabledProperty, value); }
        }

        public ColorImageFormat ColorFormat
        {
            get { return (ColorImageFormat)GetValue(ColorFormatProperty); }
            set { SetValue(ColorFormatProperty, value); }
        }

        public bool DepthStreamEnabled
        {
            get { return (bool)GetValue(DepthStreamEnabledProperty); }
            set { SetValue(DepthStreamEnabledProperty, value); }
        }

        public DepthImageFormat DepthFormat
        {
            get { return (DepthImageFormat)GetValue(DepthFormatProperty); }
            set { SetValue(DepthFormatProperty, value); }
        }

        public DepthRange DepthRange
        {
            get { return (DepthRange)GetValue(DepthRangeProperty); }
            set { SetValue(DepthRangeProperty, value); }
        }

        public bool SkeletonStreamEnabled
        {
            get { return (bool)GetValue(SkeletonStreamEnabledProperty); }
            set { SetValue(SkeletonStreamEnabledProperty, value); }
        }

        public SkeletonTrackingMode SkeletonTrackingMode
        {
            get { return (SkeletonTrackingMode)GetValue(SkeletonTrackingModeProperty); }
            set { SetValue(SkeletonTrackingModeProperty, value); }
        }
        ...
        {
            get { return (TransformSmoothParameters)GetValue(TransformSmoothParametersProperty); }
            set { SetValue(TransformSmoothParametersProperty, value); }
        }
        ...
        {
            get { return (Vector4)GetValue(AccelerometerProperty); }
            set { SetValue(AccelerometerProperty, value); }
        }
        ...
        private static void KinectSensorOrStatusChanged(DependencyObject sender, DependencyPropertyChangedEventArgs args)
        {
            ...
            bool sensorChanged = KinectSensorProperty == args.Property;
            bool statusChanged = KinectSensorStatusProperty == args.Property;
        ...
        {
            if (null != KinectAppConflictChanged)
            {
                KinectAppConflictChanged(this, new KinectSensorManagerEventArgs<bool>(this, !KinectSensorAppConflict, KinectSensorAppConflict));
            }
        }
        ...
        {
            EnsureColorStreamState();
            EnsureDepthStreamState();
            EnsureSkeletonStreamState();
            EnsureElevationAngle();
            EnsureForceInfraredEmitterOff();
            EnsureKinectSensorRunningState();
            EnsureAccelerometer();
        }
            ...
            if (KinectSensorEnabled)
            {
                if (!sensor.IsRunning)
                {
                    ...
                    try
                    {
                        ...
                        KinectSensorAppConflict = false;
                    }
                    catch (IOException)
                    {
                        KinectSensorAppConflict = true;
                    }
                    catch (InvalidOperationException)
                    {
        ...
        private void EnsureDepthStreamState()
        {
            ...
            if (DepthStreamEnabled)
            {
                ...
                try
                {
                    sensor.DepthStream.Range = DepthRange;
                }
                catch (InvalidOperationException)
                {
        ...
        private void EnsureSkeletonStreamState()
        {
            ...
            bool skeletonChangeWillCauseAudioReset = sensor.SkeletonStream.IsEnabled != SkeletonStreamEnabled;
            ...
            if (SkeletonStreamEnabled)
            {
                try
                {
                    ...
                    sensor.SkeletonStream.TrackingMode = SkeletonTrackingMode;
                    sensor.SkeletonStream.EnableTrackingInNearRange = SkeletonEnableTrackingInNearMode;
                }
                catch (InvalidOperationException)
                {
                    // The device went away while we were trying to start
            ...
            {
                if (null != AudioWasResetBySkeletonEngine)
                {
                    AudioWasResetBySkeletonEngine(this, new EventArgs());
                }
            }
        }
        ...
        private void EnsureElevationAngle()
        {
            ...
            targetElevationAngle = ElevationAngle;
        ...
        private void EnsureForceInfraredEmitterOff()
        {
            ...
            try
            {
                sensor.ForceInfraredEmitterOff = ForceInfraredEmitterOff;
            }
            catch (InvalidOperationException)
            {
                ForceInfraredEmitterOff = false;
            }
        }
        ...
        private void AccelerometerAllFramesReady(object sender, AllFramesReadyEventArgs e)
        {
            ...
            {
                Accelerometer = KinectSensor.AccelerometerGetCurrentReading();
            }
        }
    }
}